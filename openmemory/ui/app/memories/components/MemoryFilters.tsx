"use client";
import { Archive, Pause, Play, X, RefreshCw, Search } from "lucide-react";
...
export function MemoryFilters() {
  ...
  const handleSearch = debounce(async (query: string) => {
    // Actually trigger the search API call
  ...
  const onRefresh = () => {
    // Get current search term and refresh
    const currentQuery = inputRef.current?.value || "";
    fetchMemories(currentQuery);
  };
